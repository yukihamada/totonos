...
const defaultMenuGroups: MenuGroupConfig[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'line-settings', title: 'LINE連携', visible: true, order: 7 },
      { id: 'settings-menu', title: 'メニュー設定', visible: true, order: 8 },
      { id: 'developer', title: '開発者設定', visible: true, order: 9 },
      { id: 'api-docs', title: 'APIドキュメント', visible: true, order: 10 },
      { id: 'mcp-settings', title: 'MCP設定', visible: true, order: 11 },
    ],
  },
  {
    id: 'billing',
