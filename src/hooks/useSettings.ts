...
const defaultMenuGroups: MenuGroupConfig[] = [
  {
    ...
    items: [
      ...
      { id: 'notifications', title: '通知センター', visible: true, order: 2 },
      { id: 'profile', title: 'プロフィール', visible: true, order: 3 },
    ],
  },
  {
    id: 'crm',
    ...
    items: [
      ...
      { id: 'sales-forecast', title: 'AI売上予測', visible: true, order: 6 },
    ],
  },
  {
    id: 'documents',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ledger', title: '総勘定元帳', visible: true, order: 2 },
      { id: 'statements', title: '財務諸表', visible: true, order: 3 },
      { id: 'budget', title: '予算管理', visible: true, order: 4 },
      { id: 'receivables', title: '売掛金年齢表', visible: true, order: 5 },
      { id: 'payables', title: '買掛金管理', visible: true, order: 6 },
      { id: 'assets', title: '固定資産', visible: true, order: 7 },
      { id: 'expenses', title: '経費管理', visible: true, order: 8 },
      { id: 'receipt-capture', title: 'レシートOCR', visible: true, order: 9 },
      { id: 'tax', title: '消費税管理', visible: true, order: 10 },
      { id: 'period-close', title: '期末締め', visible: true, order: 11 },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'gantt', title: 'ガントチャート', visible: true, order: 1 },
      { id: 'kanban', title: 'カンバン', visible: true, order: 2 },
      { id: 'timelog', title: '工数記録', visible: true, order: 3 },
    ],
  },
  {
    id: 'recruiting',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'employee-portal', title: '従業員ポータル', visible: true, order: 9 },
    ],
  },
  {
    id: 'info',
    ...
    items: [
      ...
      { id: 'delivery-notes', title: '納品書', visible: true, order: 5 },
      { id: 'auto-reorder', title: '自動発注', visible: true, order: 6 },
    ],
  },
  {
    id: 'integrations',
    ...
    order: 10,
    items: [
      { id: 'integrations', title: '連携一覧', visible: true, order: 0 },
      { id: 'email-integration', title: 'メール連携', visible: true, order: 1 },
      { id: 'inbound-emails', title: 'メール受信', visible: true, order: 2 },
      { id: 'email-templates', title: 'メールテンプレート', visible: true, order: 3 },
      { id: 'line-settings', title: 'LINE連携', visible: true, order: 4 },
      { id: 'slack-integration', title: 'Slack連携', visible: true, order: 5 },
  ...
  },
  {
    ...
    order: 11,
    items: [
      { id: 'settings', title: '設定', visible: true, order: 0 },
      { id: 'company-settings', title: '会社設定', visible: true, order: 1 },
      { id: 'team', title: 'チーム', visible: true, order: 2 },
      { id: 'workflows', title: 'ワークフロー', visible: true, order: 3 },
      { id: 'approval-workflow', title: '承認ワークフロー', visible: true, order: 4 },
      { id: 'audit-log', title: '監査ログ', visible: true, order: 5 },
      { id: 'ai-settings', title: 'AI設定', visible: true, order: 6 },
      { id: 'data-import', title: 'データ取込', visible: true, order: 7 },
      { id: 'backup', title: 'バックアップ設定', visible: true, order: 8 },
      { id: 'settings-menu', title: 'メニュー設定', visible: true, order: 9 },
      { id: 'developer', title: '開発者設定', visible: true, order: 10 },
      { id: 'api-docs', title: 'APIドキュメント', visible: true, order: 11 },
      { id: 'mcp-settings', title: 'MCP設定', visible: true, order: 12 },
    ],
  },
  {
    id: 'billing',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'referrals', title: '紹介プログラム', visible: true, order: 1 },
      { id: 'usage', title: '使用状況', visible: true, order: 2 },
