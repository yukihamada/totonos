...
const defaultMenuGroups: MenuGroupConfig[] = [
  ...
  // 4. 会計・経費
  {
    ...
    items: [
      ...
      { id: 'advance-payment', title: '仮払い', visible: true, enabled: true, order: 12 },
      { id: 'e-bookkeeping', title: '電子帳簿保存', visible: true, enabled: true, order: 13 },
      // 準備中（デフォルトOFF）
      { id: 'reconciliation', title: '自動消込', visible: false, enabled: false, order: 14 },
      { id: 'bank-connections', title: '銀行連携', visible: false, enabled: false, order: 15 },
    ],
  },
  // 5. 人事・採用
  {
    ...
    items: [
      ...
      { id: 'recruiting', title: '採用ダッシュボード', visible: true, enabled: true, order: 10 },
      { id: 'job-postings', title: '求人管理', visible: true, enabled: true, order: 11 },
      { id: 'candidates', title: '候補者管理', visible: true, enabled: true, order: 12 },
      { id: 'interviews', title: '面接スケジュール', visible: true, enabled: true, order: 13 },
      { id: 'recruiting-reports', title: '採用レポート', visible: true, enabled: true, order: 14 },
    ],
  },
  // 6. プロジェクト
  {
    ...
    order: 5,
    items: [
      { id: 'projects', title: 'プロジェクト一覧', visible: true, enabled: true, order: 0 },
  ...
  // 7. ナレッジ・情報
  {
    ...
    order: 6,
    items: [
      { id: 'wiki-hierarchy', title: '社内Wiki', visible: true, enabled: true, order: 0 },
      { id: 'database-views', title: 'データベース', visible: true, enabled: true, order: 1 },
      { id: 'it-assets', title: 'IT資産', visible: true, enabled: true, order: 2 },
      { id: 'products', title: '商品管理', visible: true, enabled: true, order: 3 },
      { id: 'auto-reorder', title: '自動発注', visible: true, enabled: true, order: 4 },
    ],
  },
  // 8. 設定・連携
  {
    ...
    items: [
      ...
      { id: 'settings-menu', title: 'メニュー設定', visible: true, enabled: true, order: 3 },
      { id: 'integrations', title: '連携一覧', visible: true, enabled: true, order: 4 },
      { id: 'email-integration', title: 'メール連携', visible: true, enabled: true, order: 5 },
      { id: 'inbound-emails', title: 'メール受信', visible: true, enabled: true, order: 6 },
      { id: 'email-templates', title: 'メールテンプレート', visible: true, enabled: true, order: 7 },
      { id: 'line-settings', title: 'LINE連携', visible: true, enabled: true, order: 8 },
      { id: 'slack-integration', title: 'Slack連携', visible: true, enabled: true, order: 9 },
      { id: 'sso-settings', title: 'SSO設定', visible: true, enabled: true, order: 10 },
      { id: 'workflows', title: 'ワークフロー', visible: true, enabled: true, order: 11 },
      { id: 'approval-workflow', title: '承認ワークフロー', visible: true, enabled: true, order: 12 },
      { id: 'audit-log', title: '監査ログ', visible: true, enabled: true, order: 13 },
      { id: 'ai-settings', title: 'AI設定', visible: true, enabled: true, order: 14 },
      { id: 'data-import', title: 'データ取込', visible: true, enabled: true, order: 15 },
      { id: 'backup', title: 'バックアップ設定', visible: true, enabled: true, order: 16 },
      { id: 'developer', title: '開発者設定', visible: true, enabled: true, order: 17 },
    ],
  },
  // 9. プラン・課金
  {
    ...
    items: [
      ...
      { id: 'referrals', title: '紹介プログラム', visible: true, enabled: true, order: 3 },
      { id: 'usage', title: '使用状況', visible: true, enabled: true, order: 4 },
    ],
  },
  // 10. レポート
  {
    ...
    items: [
      ...
      { id: 'pages', title: 'ページ一覧', visible: false, enabled: true, order: 1 },
    ],
  },
  // === 医療・ヘルスケア（専門機能、デフォルトOFF） ===
  {
    ...
    items: [
      ...
      { id: 'emr-appointments', title: '予約管理', visible: false, enabled: false, order: 7 },
      { id: 'emr-billing', title: '会計・レセプト', visible: false, enabled: false, order: 8 },
      { id: 'emr-pharmacy', title: '処方箋・薬局', visible: false, enabled: false, order: 9 },
      { id: 'emr-home-visit', title: '訪問診療', visible: false, enabled: false, order: 10 },
      { id: 'emr-telemedicine', title: 'オンライン診療', visible: false, enabled: false, order: 11 },
      { id: 'emr-health-checkup', title: '健診・人間ドック', visible: false, enabled: false, order: 12 },
    ],
  },
  // === 会員管理（道場・フィットネス等） ===
  {
